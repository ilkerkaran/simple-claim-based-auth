...
{
    public class AuthorityRequirementFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (allowedPermissionList.Count > 0
                && false == allowedPermissionList.Any(authority => context.HttpContext.User.IsInRole(((int)authority).ToString())))
